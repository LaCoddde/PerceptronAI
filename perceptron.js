...
for (let i = 0; i < numIterations; i++) {
    ...
    for (const [inputs, desiredOutput] of trainingData) {
      ...
      console.log(`Input: ${inputs}, Desired Output: ${desiredOutput}, 
        Predicted Output: ${predictedOutput}, Error: ${error.toFixed(2)}, 
        Updated Weights: (${weight1.toFixed(2)}, ${weight2.toFixed(2)}), 
        Updated Bias: ${bias.toFixed(2)}`);
